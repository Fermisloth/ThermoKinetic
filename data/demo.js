...
const DATA_FILE = path.join(__dirname, "../data/demo-requests.json");
 ...
 *   role: string,
 *   email: string,
 *   monthlyShipmentVolume: string,  // range label e.g. "500–2000"
 *   message?: string
 * }
 */
router.post(
 ...
 * Returns all demo requests — protected by ADMIN_KEY header for hackathon
 */
